    ...
    render() {
        return (
            <div className='flex flex-col justify-center items-center bg-black w-full h-screen'>
                ...
                <div id="api-tile-container" className='grid w-3/4 grid-cols-4 h-[500px] grid-flow-row gap-1 bg-black'>
                ...
                <div id="custom-exercise-tile" className='grid w-3/4 grid-cols-4 h-[500px] gap-4 bg-black'>
